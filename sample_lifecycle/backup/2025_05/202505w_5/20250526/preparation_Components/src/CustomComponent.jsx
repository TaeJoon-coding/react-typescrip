...
class CustomComponent extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        console.log('getDerivedStateFromProps 呼び出し : ', props.props_value);
        return {
    ...
    componentDidMount() {
        console.log("componentDidMount 呼び出し");
    ...
    shouldComponentUpdate(props, state) {
        console.log("shouldComponentUpdate 呼び出し");
